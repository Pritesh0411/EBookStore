    ...
    <div class="row">
      <div class="col-sm-2">
        <div class="list-group list-group-flush" style="text-align: center;">
          <a href="CustomerHome.php" class="list-group-item active list-group-item-action bg-secondary text-white">Home</a>
        </div>
        <hr>
      ...
      <div class="col-sm-10">
        <div class="container-fluid bg-light mb-1" style="text-align: center; padding-top: 5px; padding-bottom: 5px;"><h4>Top Selling Books</h4></div>
        <hr>
        <?php
          $sql="SELECT * FROM ORDERS GROUP BY ISBN ORDER BY SUM(Quantity) DESC";
              ...
              <a href="javascript:;" class="bookcard" data-isbn="<?php echo $ISBN;?>" style="text-decoration: none; color: black;">
                <div class="card mb-3 bg-light h-100">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text" style="margin-bottom: 5px;"><?php echo 'Rs.'.$brow['Price']; ?></p>
                    <?php
                      if($avl==0){
                    ?>
                    ...
                    <?php
                      if($crtrow==1){
                    ?>
                      <button type="button" class="btn btn-primary removefromcart" data-isbn="<?php echo $ISBN; ?>" id="<?php echo 'c1'.$rowB['ISBN']; ?>">Remove from Cart</button>
                      <button type="button" class="btn btn-primary addtocart" data-isbn="<?php echo $ISBN; ?>" style="display: none;" id="<?php echo 'c2'.$rowB['ISBN']; ?>">Add to Cart</button>
                    <?php
                      }
                      else{
                    ?>
                      <button type="button" class="btn btn-primary removefromcart" data-isbn="<?php echo $ISBN; ?>" style="display: none;" id="<?php echo 'c1'.$rowB['ISBN']; ?>">Remove from Cart</button>
                      <button type="button" class="btn btn-primary addtocart" data-isbn="<?php echo $ISBN; ?>" id="<?php echo 'c2'.$rowB['ISBN']; ?>">Add to Cart</button>
                    <?php
                      }
                    ?>                  
