...
<body>
  ...
  <div class="container-fluid" style="margin-top: 0px">
    <div class="row">
    	<div class="col-sm-12">
    		<hr>
        <div class="container-fluid bg-light mb-1" style="text-align: center; padding-top: 5px; padding-bottom: 5px;"><h4>My Wishlist</h4></div>
        <hr>
        <?php
        	$sql="SELECT ISBN FROM WISHLIST WHERE EmailId='$user'";
        ...
        <div class="row row-cols-1 row-cols-md-4">
          ...
          ?>
            <div class="col mb-4" id="<?php echo "wl".$ISBN; ?>">
