<?php
  ...
  if($_SERVER['REQUEST_METHOD']=="POST"){
    ...
    $Bk=mysqli_fetch_array($res1,MYSQLI_ASSOC);
    $TP=$Bk['Price'];
  }
  else{
...
<body>
  ...
  <br>
  <br>
  <div class="container bg-light mb-1" style="text-align: center; padding-top: 5px; padding-bottom: 5px;"><h4>Total Price: <?php echo $TP; ?></h4></div>
  <br>
  <br>
  <br>
  <center>
    <form method="POST" action="CustBuyPlace.php" >
