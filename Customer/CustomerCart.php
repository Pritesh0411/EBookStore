...
<body>
  ...
  <div class="container-fluid" style="margin-top: 0px">
    <div class="row">
    	<div class="col-sm-12">
    		<hr>
        <div class="container-fluid bg-light mb-1" style="text-align: center; padding-top: 5px; padding-bottom: 5px;"><h4>My Cart</h4></div>
        <hr>
        <?php
        	$sql="SELECT ISBN FROM CART WHERE EmailId='$user'";
        ...
        <div class="row row-cols-1 row-cols-md-4">
          ...
          ?>
            <div class="col mb-4" id="<?php echo "crt".$ISBN; ?>">
              <a href="CustomerLogout.php" style="text-decoration: none; color: black;">
              <div class="card mb-3 bg-light h-100">
                ...
                <div class="card-body">
                  ...
                  <a href="CustomerPurchase.php" class="btn btn-primary">Buy Now</a> &nbsp
                  <?php
                    if($crtrow==1){
                  ?>
    ...
    <br>
    <center>
    	<form method="POST" action="CustPlaceOrder.php" >
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $(".removefromcart").click(function(){
        ...
        var ColChange3="crt".concat(ISBN);
        $("#"+ColChange).css("display","none");
        $("#"+ColChange2).css("display","inline");
